...
class MusicPlayer:
  ...
  def __init__(self,root):
    ...
    # Create Status Bar
    self.status_bar = Label(root,font=("Comic Sans MS",8),text='',bd=1,relief=FLAT,anchor=E,bg="#ff69eb",fg="black")
    ...
    selectbtn = Button(self.status_bar,text="SELECT",command=self.selectfolder,width=5,height=1,font=("Comic Sans MS",10),
                    fg="black",bg="#ff69eb",relief=FLAT, activebackground="#ff69eb").grid(row=0,column=3,padx=2,pady=2)
