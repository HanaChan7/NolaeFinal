...
class MusicPlayer:
  ...
  def __init__(self,root):
    ...
    # Create Status Bar
    self.status_bar = Label(root,font=("Comic Sans MS",8),text='',bd=1,relief=FLAT,anchor=E,bg="#033860",fg="white")
    ...
    backbtn = Button(self.status_bar,text="BACK",command=self.back,width=5,height=1,font=("Comic Sans MS",10),
                    fg="white",bg="#033860",relief=FLAT, activebackground="#1210d9").grid(row=0,column=1,padx=2,pady=2)
    selectbtn = Button(self.status_bar,text="SELECT",command=self.selectfolder,width=5,height=1,font=("Comic Sans MS",10),
                    fg="white",bg="#033860",relief=FLAT, activebackground="#1210d9").grid(row=0,column=3,padx=2,pady=2)
